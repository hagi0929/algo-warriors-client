      ...
      >
        <div className="flex flex-col gap-[7px]">
          ...
          <div className="flex flex-col gap-[15px]">
            <div>
              <div className="text-mauve12 m-0 text-[15px] font-medium leading-[1.5]">Username</div>
              <div className="text-mauve10 m-0 text-[15px] leading-[1.5]">@userid</div>
            </div>
            ...
            <div className="flex gap-[15px]">
              <div className="flex gap-[5px]">
                <div className="text-mauve10 m-0 text-[15px] leading-[1.5]">Account Created:</div>
                <div className="text-mauve12 m-0 text-[15px] font-medium leading-[1.5]">YEAR-MONTH-DAY</div>{' '}
              </div>
            </div>
          </div>
        </div>
